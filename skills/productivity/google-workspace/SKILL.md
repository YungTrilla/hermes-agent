...
| `AUTHENTICATED (partial)` or "Token missing scopes" | The token is missing one or more scopes selected during its own authorization flow (not unrelated Workspace services). Revoke and repeat Steps 3-5 with the service set you actually need. |
